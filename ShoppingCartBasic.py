...
class ShoppingCart:
    ...
    def add_items(self):
        while True:
            item_details = input("Enter item, price, and quantity (or 'n' to finish): ").lower()
            if item_details == "n":
                break
    ...
    def add_new_or_existing_items(self):
        ...
        for _ in range(no_of_item):
            if r == "n":
                item_details = input("Enter item details (name price quantity): ").lower()
                try:
                ...
                item_name, item_quantity = input("Enter the name of the item and quantity: ").lower().split()
                item_quantity = int(item_quantity)
                if item_name in self.cart:
